...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИначеЕсли ПараметрыЗаписи.ТипТаблицы = "РегистрНакопления" 
		...
		Если ПараметрыЗаписи.ТипТаблицы = "РегистрНакопления" Тогда
			РегистрМетаданные = Метаданные.РегистрыНакопления[ПараметрыЗаписи.ИмяТаблицы];
		ИначеЕсли ПараметрыЗаписи.ТипТаблицы = "РегистрСведений" Тогда
			//РегистрМетаданные = Метаданные.РегистрыСведений[ПараметрыЗаписи.ИмяТаблицы];
		ИначеЕсли ПараметрыЗаписи.ТипТаблицы = "РегистрРасчета" Тогда
			РегистрМетаданные = Метаданные.РегистрыРасчета[ПараметрыЗаписи.ИмяТаблицы];
		КонецЕсли;
		...
		Для каждого СтРеквизит Из РегистрМетаданные.СтандартныеРеквизиты Цикл
		...
		Для каждого Реквизит Из РегистрМетаданные.Реквизиты Цикл
